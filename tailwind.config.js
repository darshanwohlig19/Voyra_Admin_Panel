...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        custom: '0px 0px 4.77px 0.99px rgba(0, 0, 0, 0.04)',
    ...
    colors: {
      ...
      vividSkyBlue: '#3d81f4',
      moderateBlue: '#598dff',
      darkTaupeGray: '#27272c',
      darkGrayishBlue: '#343941',
      grayishBlue: '#7f818a',
      veryDarkBlueGray: '#1c1e22',
      graySlightBluish: '#f5f6fa',
      darkGray: '#333333',
      lightGray: '#E0E0E0',
      cerulean: '213468',
      white: '#FFFFFF',
      ...
      charcoalBlack: '#202224',
      blueSecondary: '#6E56FB',
      brandLinear: '#868CFF',
      dropdownBg: '#e4ecfd',
      chineseBlack: '#1d1e20',
      ...
      purple: {
        ...
        900: '#581c87',
        customShade: '#8C72FF',
        lightViolet: '#4318ffba',
        hanPurple: '#4318fff2',
        darkHanPurple: '#4318FF',
      },
      pink: {
        5: '#F2D3DD',
        10: '#FF0053',
