...
/**
 * Component for displaying mini statistics.
 *
 * @param {Object} props - Object containing name, value, icon, and iconBg properties
 * @return {JSX.Element} The JSX element representing the mini statistics component
 */
