...
const EditCtaModal = ({ isOpen, onClose, onSubmit, loading, ctaData }) => {
  ...
  useEffect(() => {
    if (ctaData && isOpen) {
      ...
      setImagePreview(ctaData.backgroundImage?.url || null)
      setImage(null)
      setErrors({})
    }
  }, [ctaData, isOpen])
        ...
        <div className="space-y-4 p-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              placeholder="e.g., Join thousands of artists worldwide"
              rows={3}
              className={`w-full rounded-lg border px-4 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-navy-600 dark:bg-navy-700 dark:text-white ${
