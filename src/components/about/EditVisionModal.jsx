...
const EditVisionModal = ({
  ...
  useEffect(() => {
    if (visionData && isOpen) {
      setFormData({
        title: visionData.title || '',
        subtitle: visionData.subtitle || '',
        description: visionData.description || '',
      })
      setImagePreview(visionData.images?.[0]?.url || null)
      setImage(null)
      setErrors({})
    }
  }, [visionData, isOpen])
  ...
  const handleSubmit = () => {
    ...
    onSubmit(visionData._id, submitData)
  }
        ...
        <div className="space-y-4 p-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="e.g., The Future Awaits"
              className={`w-full rounded-lg border px-4 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-navy-600 dark:bg-navy-700 dark:text-white ${
