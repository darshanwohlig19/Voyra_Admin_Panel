...
const EditLimelightModal = ({
  ...
  useEffect(() => {
    if (limelightData && isOpen) {
      setTitle(limelightData.title || '')
      setDescription(limelightData.description || '')
      setErrors({})
    }
  }, [limelightData, isOpen])
...
export default EditLimelightModal
