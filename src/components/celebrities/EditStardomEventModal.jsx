      ...
      <div className="relative max-h-[90vh] w-[500px] overflow-y-auto rounded-lg bg-white shadow-lg dark:bg-navy-800">
        ...
        <div className="space-y-4 p-6">
          ...
          <div>
            ...
            {!imagePreview ? (
              <label
                className={`flex h-40 cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed transition-colors hover:bg-gray-50 dark:hover:bg-navy-700 ${
                  errors.image
                    ? 'border-red-500'
                    : 'border-gray-300 dark:border-navy-600'
                }`}
              ...
              <div className="group relative">
                <img
                  src={imagePreview}
                  alt="Preview"
                  className="h-40 w-full rounded-lg bg-gray-100 object-contain dark:bg-navy-700"
                />
