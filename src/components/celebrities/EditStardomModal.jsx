...
const EditStardomModal = ({
  ...
  useEffect(() => {
    if (stardomData && isOpen) {
      setTitle(stardomData.title || '')
      setDescription(stardomData.description || '')
      setErrors({})
    }
  }, [stardomData, isOpen])
...
export default EditStardomModal
