...
const AddCelebrityCarouselModal = ({ isOpen, onClose, onSubmit, loading }) => {
      ...
      <div className="relative max-h-[90vh] w-[600px] overflow-y-auto rounded-lg bg-white shadow-lg dark:bg-navy-800">
        ...
        <div className="space-y-4 p-6">
          ...
          <div>
            ...
            {!imagePreview ? (
              <label
                className={`flex h-48 cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed transition-colors hover:bg-gray-50 dark:hover:bg-navy-700 ${
                  errors.image
                    ? 'border-red-500'
...
export default AddCelebrityCarouselModal
