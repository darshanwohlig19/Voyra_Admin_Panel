...
const EditCraftedDesignModal = ({
  ...
  useEffect(() => {
    if (craftedData && isOpen) {
      setFormData({
        title: craftedData.title || '',
        description: craftedData.description || '',
      })
      setErrors({})
    }
  }, [craftedData, isOpen])
          ...
          <div className="space-y-4 p-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., Designs Crafted, Emotions Captured"
...
export default EditCraftedDesignModal
