/**
 * Function for rendering a checkbox component with customizable color and additional styles.
 *
 * @param {object} props - An object containing the component's properties, including extra styles, color, and other attributes
 * @return {JSX.Element} An input element representing the checkbox component
 */
    ...
    <input
      ...
      checked:border-none checked:text-white hover:cursor-pointer dark:border-white/10 ${
        color === 'red'
          ...
          : color === 'blue'
          ? 'checked:border-none checked:bg-[#ebd6ac] dark:checked:bg-blue-400'
          : color === 'green'
          ...
          : color === 'indigo'
          ? 'checked:bg-indigo-500 dark:checked:bg-indigo-400 checked:border-none'
          : color === 'gray'
