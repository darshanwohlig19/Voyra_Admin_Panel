/**
 * Create a radio input component with customizable color and other props.
 *
 * @param {object} props - Object containing color, id, name, and other props
 * @return {JSX.Element} The radio input element
 */
const Radio = (props) => {
      ...
      className={`before:contet[""] relative h-5 w-5 cursor-pointer appearance-none rounded-full
       ...
       ${
         color === 'red'
           ...
           : color === 'blue'
           ? 'checked:!border-blue-500 checked:before:!bg-[#ebd6ac] dark:checked:!border-blue-400 dark:checked:before:!bg-blue-400'
           : color === 'green'
