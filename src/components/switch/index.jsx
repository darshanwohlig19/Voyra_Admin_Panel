/**
 * Renders a switch component with customizable color and additional classes.
 *
 * @param {Object} props - The properties for the switch component.
 * @param {string} props.extra - Additional classes to be applied to the switch.
 * @param {string} props.color - The color of the switch.
