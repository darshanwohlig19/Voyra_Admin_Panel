...
/**
 * Function to render the Alerts component.
 *
 * @return {JSX.Element} React component
 */
const Alerts = () => {
  return (
    <div className="mt-16 flex w-full flex-col items-center justify-center rounded-[20px] bg-white dark:bg-[#27272c] md:py-12 lg:py-28 3xl:py-40">
